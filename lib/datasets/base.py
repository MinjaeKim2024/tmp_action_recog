...
class Datasets(Dataset):
    ...
    def __init__(self, args, ground_truth, modality, phase='train'):
        ...
        def get_data_list_and_label(data_df):
            # data_df:  /home/minjae/ws/data/nvGesture/Video_data/valid.txt
        ...
        #               ('class_02/subject1_r0/sk_color.avi', 329, 1), 
        #               ('class_03/subject1_r0/sk_color.avi', 329, 1)]
        if phase == 'train':
        ...
        # batch data size:  4 only for train
